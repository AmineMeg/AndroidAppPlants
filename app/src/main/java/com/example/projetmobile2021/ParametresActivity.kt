...
import com.example.projetmobile2021.databinding.ActivityParametresBinding
...
class ParametresActivity : AppCompatActivity() {
    ...
    private fun setAlarm() {
        ...
        Toast.makeText(this, "Le rappel est bien enregistré", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun showTimePicker() {
        picker = MaterialTimePicker.Builder()
            ...
            .setHour(12)
            .setMinute(0)
            .setTitleText("Choissiez l'heure du rappel")
            .build()
